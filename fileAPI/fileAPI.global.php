...
if (!function_exists('fileAPI_prepare'))
{
	...
	function fileAPI_prepare($area)
	{
		...
		cot::$cfg['fileAPI']['prepare'] = 'area: '.$area.', cat:fileapi_prepare, indf: '.cot::$usr['id'];
...
if (!function_exists('fileAPI_files'))
{
	...
	function fileAPI_files($param, $thumb_dir = '')
	{
		...
		return get_fileAPI_files($param, $thumb_dir,false,'fileAPI.display.view');
